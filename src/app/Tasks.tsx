    ...
    <section className="center md:px-10 px-3 my-8 md:my-20">
      <div className="max-w-screen-2xl w-full">
        ...
        <div className="flex flex-wrap lg:gap-10 w-full max-w-screen-2xl">
          <div className="md:w-[40%] flex justify-center w-full md:justify-end items-center h-full mt-10">
            <Image src={system} alt="system not found" width={500}/>
          </div>

          <div className="flex-1 space-y-3 min-w-[300px] px-3 md:mt-10 text-[#1B1B1B] font-normal text-[16px] leading-7">
            {faqs.map((item, index) => (
