...
export default function Banner() {
  return (
    <section
      id="home"
      className="bg-gradient-to-b from-[#CCFAFF94] to-[#FFFFFF] h-[450px] relative overflow-hidden flex justify-center items-center"
    >
      <Navbar />
      ...
      <p className="lg:text-[4rem] font-bold z-10 max-sm:text-xl max-sm:text-center px-1 sm:text-2xl md:text-5xl">
